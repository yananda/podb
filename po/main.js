...
var ActionPurchaseOrderComponent = /** @class */ (function () {
    ...
    ActionPurchaseOrderComponent.prototype.loadProductDataFields = function () {
        ...
        this.productService.getAllColorGroups().subscribe(function (res) {
            if (res) {
                ...
                // console.log(this.colorGroupOptions);
    ...
    ActionPurchaseOrderComponent.prototype.onChangeNCES = function (params, obj) {
        ...
        if (obj === 'Yes') {
            this.productService.getCategoriesFrom3DCartInventory(this.po.VendorName, this.product.ProductType).subscribe(function (res) {
                if (res) {
                    // console.log(res);
    ...
    ActionPurchaseOrderComponent.prototype.generateCategory = function () {
        ...
        if (this.product.ProductType === "Womens Shoes") {
            genderStr = delimiter + viewAllStr + separator + "Gender" + separator + "Women's";
        }
        else if (this.product.ProductType === "Mens Shoes") {
            var genderStr = delimiter + viewAllStr + separator + "Gender" + separator + "Men's";
        }
        ...
        this.poService.getProduct(prod.ID).subscribe(function (res) {
            ...
            if (res) {
                ...
                if (_this.product.NewColorOfExistingStyle === 'Yes') {
                    _this.productService.getCategoriesFrom3DCartInventory(_this.po.VendorName, _this.product.ProductType).subscribe(function (res) {
                        if (res) {
                            // console.log(res);
                            _this.tdCartCategoryOptions = res;
                        }
...
var ExportImportActionsComponent = /** @class */ (function () {
    function ExportImportActionsComponent(formBuilder, router, route, poService, ioService) {
        ...
        this.showPrefilledUploadOptions = false;
        this.po = new _helpers_purchase_order__WEBPACK_IMPORTED_MODULE_4__["PurchaseOrder"]();
        this.poService.getPurchaseOrder(id).subscribe(function (res) {
            if (res) {
                // console.log(res);
    ...
    ExportImportActionsComponent.prototype.upload3DCartExport1 = function () {
        ...
        this.ioService.uploadTDCartExportOne(formData).subscribe(function (data) {
            ...
            if (data.type === "application/json") {
                ...
                alert("Please Check File Type -Only .xls or .xlsx file allowed");
            }
            else {
    ...
    // download3DCartImportTemplate2() {
    // }
    ExportImportActionsComponent.prototype.cancelUpload1 = function () {
        this.showDownloadOptions1 = false;
        this.showUploadOptions1 = false;
    };
    ExportImportActionsComponent.prototype.ShowAvanceOptionsUpload = function () {
        this.showPrefilledUploadOptions = true;
        this.showUploadOptions1 = false;
    };
    ExportImportActionsComponent.prototype.handleAdvanceOptionsFileInputTemplate = function (event) {
        if (event.target.files.length > 0) {
            // console.log(event.target.files[0]);
            var file = event.target.files[0];
            this.form.get('inputFile').setValue(file);
    ...
    ExportImportActionsComponent.prototype.uploadPrefilledAdvanceOptions = function () {
        var formData = new FormData();
        var x = this.form.get('inputFile').value;
        // var filename = "Post_Filled_Advance_Options_" + x.name;
        var filename = "Post_Filled_Advance_Options.xls";
        // const EXT = filename.substr(filename.lastIndexOf(".") + 1);
        // console.log(EXT);
        formData.append('inputFile', this.form.get('inputFile').value);
        formData.append('poID', this.po.ID.toString());
        formData.append('action', "ImportPrefilledAdvancedOptions");
        this.ioService.ImportPrefilledAdvancedOptions(formData).subscribe(function (data) {
            // do something, if upload success
            if (data.type === "application/json") {
                // if (data == null || data === undefined || data == "") {
                // console.log("Empty Data ----- " + data);
                ...
                Object(file_saver__WEBPACK_IMPORTED_MODULE_7__["saveAs"])(new Blob([data], { type: MIME_TYPES["xls"] }), filename);
            }
        }, function (error) {
            // console.log(error);
        });
    };
    // ShowUploadOptionsFor3DExport2() {
    //   this.showUploadOptions2 = true;
    // }
    // handleFileInputTemplate2(event) {
    //   if (event.target.files.length > 0) {
    ...
    //   formData.append('poID', this.po.ID.toString());
    //   formData.append('action', "ImportTDCartExportOne");
    //   this.ioService.uploadTDCartExportOne(formData).subscribe(data => {
    //     // do something, if upload success
    //     console.log("Response Data ---" + data);
    //     this.showDownloadOptions2 = true;
    //   }, error => {
    //     console.log(error);
    //   });
    // }
    // download3DCartImportTemplate3() {
    // }
    // cancelUpload2() {
    //   this.showDownloadOptions2 = false;
    //   this.showUploadOptions2 = false;
    ...
    ExportImportActionsComponent.prototype.generate3DCartOFT = function () {
        window.open("assets/api/exportOFT.php/?poID=" + this.po.ID);
    };
...
var IOService = /** @class */ (function () {
    ...
    IOService.prototype.ImportPrefilledAdvancedOptions = function (data) {
        return this.httpClient.post(this.uploadURL, data, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('enctype', 'multipart/form-data'),
            responseType: 'blob'
            // headers: new HttpHeaders().set('enctype', 'multipart/form-data'),
...
var DataserviceService = /** @class */ (function () {
    ...
    DataserviceService.prototype.userlogin = function (username, password) {
        ...
        return this.httpClient.post(this.baseUrl + '/login.php', { username: username, password: password })
            ...
            _this.setUserToken(Usermodule[0].ID);
    ...
    DataserviceService.prototype.setUserToken = function (token) {
        localStorage.setItem('tokenID', token);
    };
    DataserviceService.prototype.getUserToken = function () {
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getCategoriesFrom3DCartInventory = function (VendorName, ProductType) {
        var obj = { 'action': 'getCategoriesFrom3DCartInventory', VendorName: VendorName, ProductType: ProductType };
        return this.httpClient.post(this.productUrl, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8'),
            responseType: 'json',
            params: obj
...
/* harmony import */ var _dataservice_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dataservice.service */ "./src/app/services/dataservice.service.ts");
...
var PurchaseOrderService = /** @class */ (function () {
    function PurchaseOrderService(httpClient, dataService) {
        this.httpClient = httpClient;
        this.dataService = dataService;
    ...
    PurchaseOrderService.prototype.addPurchaseOrder = function (po) {
        var userID = this.dataService.getUserToken();
        var obj = { 'action': 'addNewPurchaseOrder', po: po, userID: userID };
        return this.httpClient.post(this.poUrl, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8'),
            responseType: 'json',
            params: obj
    ...
    PurchaseOrderService.prototype.addProduct = function (product) {
        var userID = this.dataService.getUserToken();
        var obj = { 'action': 'addNewProduct', product: product, userID: userID };
        return this.httpClient.post(this.poUrl, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8'),
            responseType: 'json',
            params: obj
    ...
    PurchaseOrderService.prototype.updatePurchaseOrder = function (po) {
        var userID = this.dataService.getUserToken();
        var obj = { 'action': 'updatePurchaseOrder', po: po, userID: userID };
        return this.httpClient.post(this.poUrl, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8'),
            responseType: 'json',
            params: obj
    ...
    PurchaseOrderService.prototype.updateProduct = function (product) {
        var userID = this.dataService.getUserToken();
        var obj = { 'action': 'updateProduct', product: product, userID: userID };
        return this.httpClient.post(this.poUrl, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8'),
            responseType: 'json',
            params: obj
    ...
    PurchaseOrderService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _dataservice_service__WEBPACK_IMPORTED_MODULE_6__["DataserviceService"]])
